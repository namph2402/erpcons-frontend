...
const KPIS = [
  { id: 'k1', label: 'Giá trị hợp đồng', value: '45,800,000,000', unit: 'VND', icon: 'contract', tone: 'info' },
  { id: 'k2', label: 'Giá trị đã thanh toán', value: '18,320,000,000', unit: 'VND', icon: 'payments', tone: 'success', sub: '40.0%' },
  { id: 'k3', label: 'Giá trị còn lại', value: '27,480,000,000', unit: 'VND', icon: 'savings', tone: 'warning', sub: '60.0%' },
  { id: 'k4', label: 'Tiến độ hợp đồng', value: '58.6%', icon: 'donut_small', tone: 'ai', sub: 'Kế hoạch: 75.0%' },
  { id: 'k5', label: 'Thời hạn hoàn thành', value: '30/09/2025', icon: 'event_available', tone: 'neutral', sub: 'Còn 129 ngày' },
]
...
const PHASES: PhaseRow[] = [
  { id: '1', name: '1. Công tác chuẩn bị', tasks: '3 công việc', plan: 100, actual: 100, status: 'Hoàn thành' },
  { id: '2', name: '2. Thi công phần móng', tasks: '8 công việc', plan: 100, actual: 80, status: 'Đang thực hiện' },
  { id: '3', name: '3. Thi công hầm', tasks: '6 công việc', plan: 75, actual: 45, status: 'Đang thực hiện' },
  { id: '4', name: '4. Công tác hoàn thiện', tasks: '4 công việc', plan: 0, actual: 0, status: 'Chưa bắt đầu' },
  { id: '5', name: '5. Nghiệm thu & bàn giao', tasks: '3 công việc', plan: 0, actual: 0, status: 'Chưa bắt đầu' },
]
...
const UPCOMING = [
  { id: 'u1', name: 'Đợt 4 - Thi công hầm B2', plan: 'Kế hoạch: 30/06/2024', amount: '3,850,000,000' },
  { id: 'u2', name: 'Đợt 5 - Thi công hầm B1', plan: 'Kế hoạch: 31/07/2024', amount: '4,250,000,000' },
  { id: 'u3', name: 'Đợt 6 - Thi công hầm B1', plan: 'Kế hoạch: 31/08/2024', amount: '4,700,000,000' },
]

const RISKS = [
  { id: 'r1', level: 'Cao', tone: 'danger' as const, title: 'Chậm tiến độ thi công hầm B1', date: '15/05/2024' },
  { id: 'r2', level: 'Trung bình', tone: 'warning' as const, title: 'Biến động giá thép', date: '12/05/2024' },
  { id: 'r3', level: 'Thấp', tone: 'success' as const, title: 'Thời tiết mưa nhiều', date: '10/05/2024' },
]

const TIMELINE = [
  { id: 't1', date: '15/03/2024', title: 'Ký kết hợp đồng', by: 'Trần Minh Đức', tone: 'success' as const },
  { id: 't2', date: '18/03/2024', title: 'Tạm ứng lần 1', by: 'Bùi Quang Huy', tone: 'info' as const },
  { id: 't3', date: '20/04/2024', title: 'Nghiệm thu móng', by: 'Lê Hải Đăng', tone: 'info' as const },
  { id: 't4', date: '15/05/2024', title: 'Thanh toán đợt 2', by: 'Lê Hải Đăng', tone: 'success' as const },
  { id: 't5', date: '30/09/2025', title: 'Dự kiến hoàn thành', by: '', tone: 'neutral' as const },
]

const APPROVALS = [
  { id: 'a1', title: 'Thanh toán đợt 3 - 15%', by: 'Lê Hải Đăng', date: '20/05/2024', status: 'Đã duyệt', tone: 'success' as const },
  { id: 'a2', title: 'Điều chỉnh tiến độ', by: 'Trần Minh Đức', date: '19/05/2024', status: 'Đã duyệt', tone: 'success' as const },
  { id: 'a3', title: 'Nghiệm thu hầm B2', by: 'Phạm Quang Huy', date: '18/05/2024', status: 'Chờ duyệt', tone: 'warning' as const },
]

const CONTRACT_DOCS = [
  { id: 'd1', name: 'Hợp đồng gốc', ext: 'pdf', size: '2.4 MB', meta: 'Cập nhật 15/03/2024' },
  { id: 'd2', name: 'Phụ lục 01 - Bảng khối lượng', ext: 'docx', size: '1.1 MB', meta: 'Cập nhật 18/03/2024' },
  { id: 'd3', name: 'Tiến độ tổng thể', ext: 'xlsx', size: '98 KB', meta: 'Cập nhật 20/03/2024' },
  { id: 'd4', name: 'Bảo lãnh thực hiện HĐ', ext: 'pdf', size: '1.3 MB', meta: 'Cập nhật 15/03/2024' },
]

const LINKS = [
  { id: 'l1', label: 'Dự án', meta: 'The Nexus Tower', icon: 'domain' },
  { id: 'l2', label: 'Nhà thầu', meta: 'XYZ Construction', icon: 'engineering' },
...
export default function ContractDetail() {
  ...
  const phaseColumns: Column<PhaseRow>[] = [
    ...
    { key: 'plan', header: 'Kế hoạch', width: '160px', render: (r) => <ProgressBar value={r.plan} tone="success" size="sm" showValue /> },
    { key: 'actual', header: 'Thực tế', width: '90px', align: 'right', render: (r) => <span className="num" style={{ fontWeight: 600 }}>{r.actual}%</span> },
    {
      key: 'status',
      header: 'Trạng thái',
      width: '150px',
      render: (r) => (
        <Badge tone={r.status === 'Hoàn thành' ? 'success' : r.status === 'Đang thực hiện' ? 'info' : 'neutral'}>
          {r.status}
        </Badge>
      ),
    },
  ...
  return (
    <PartnerShell
      activeId="contracts"
      breadcrumbs={[{ label: 'Hợp đồng', href: '#/lam-viec/hop-dong' }, { label: 'HD-2024-0156' }]}
      title="Hợp đồng Thi công phần móng & hầm – The Nexus Tower"
      status={<Badge tone="success" dot size="md">Đang thực hiện</Badge>}
      subtitle={
        <>
      ...
      <div className="pt-kpi-strip">
        {KPIS.map((k) => (
          <div className="pt-kpi" key={k.id}>
            <span className={`pt-kpi__icon stat-card__icon ${TONE_CLASS[k.tone]}`}>
      ...
      <div className="pt-grid pt-grid--main">
        <div className="pt-col">
          <Card
            ...
            action={
              <ul className="gantt-legend" style={{ marginTop: 0 }}>
                <li><i className="is-done" />Hoàn thành</li>
                <li><i className="is-doing" />Đang thực hiện</li>
                <li><i className="is-plan" />Chưa bắt đầu</li>
              </ul>
            }
            flush
          >
            <DataTable columns={phaseColumns} rows={PHASES} rowKey={(r) => r.id} dense />
          </Card>
          ...
          <div className="pt-grid pt-grid--3">
            ...
            <Card title="Hạng mục thanh toán sắp tới" link={{ label: 'Xem tất cả' }}>
              {UPCOMING.map((u) => (
                <div className="pt-prop" key={u.id} style={{ gridTemplateColumns: '1fr auto' }}>
                  <div>
            ...
            <div className="pt-props">
              ...
              <div className="pt-prop">
                ...
                <span className="pt-prop__value">
                  <Badge tone="success" dot>Đang thực hiện</Badge>
                </span>
              </div>
            </div>
          </Card>
              ...
              {TIMELINE.map((t) => (
                <div className="pt-timeline__item" key={t.id}>
                  ...
                  <div className="pt-timeline__body">
                    <span className={`pt-timeline__dot pt-timeline__dot--${t.tone}`} />

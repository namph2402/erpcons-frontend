...
const KPIS = [
  {
    ...
    spark: [620, 700, 760, 840, 910, 1010, 1120, 1245.8],
  },
  {
    id: "k2",
    label: "Đơn hàng",
  ...
  },
  {
    ...
    trend: { direction: "up" as const, value: "2 ticket", label: "chưa xử lý" },
...
const TICKETS = [
  {
    ...
    status: "Đang xử lý",
    tone: "info" as const,
    subject: "Hỗ trợ kỹ thuật phần mềm",
  },
  {
    id: "t2",
    code: "TIC-2024-0071",
  ...
  },
  {
    ...
    status: "Đã giải quyết",
    tone: "success" as const,
    subject: "Yêu cầu nâng cấp tính năng",
  },
];
...
const ACTIVITIES = [
  {
    id: "a1",
    actor: "Hệ thống",
    action: "Bạn đã thanh toán hóa đơn #INV-2024-0456",
    time: "15/05/2024 10:34",
    icon: "payments",
    tone: "success" as const,
  },
  {
    id: "a2",
    actor: "Hệ thống",
    action: "Đơn hàng PO-2024-0156 đã được giao",
    time: "15/05/2024 09:15",
    icon: "local_shipping",
    tone: "info" as const,
  },
  {
    id: "a3",
    actor: "Hỗ trợ",
    action: "Yêu cầu hỗ trợ #TIC-2024-0087 đã được cập nhật",
    time: "14/05/2024 16:42",
    icon: "support_agent",
    tone: "warning" as const,
  },
  {
    id: "a4",
    actor: "Hệ thống",
    action: "Hóa đơn #INV-2024-0443 đã được thanh toán",
    time: "14/05/2024 11:27",
    icon: "receipt_long",
    tone: "success" as const,
  },
  {
    id: "a5",
    actor: "Bạn",
    action: "Bạn đã tạo yêu cầu báo giá #RFQ-2024-0065",
    time: "13/05/2024 14:18",
    icon: "request_quote",
    tone: "ai" as const,
  },
];
    ...
    >
      ...
      <Card>
        <div className="row-between">
          <div className="row">
            <span
              className="count-row__icon count-row__icon--info"
            ...
            <div>
              <p
                className="pt-profile__name"
                style={{ fontSize: "var(--fs-title-2)" }}
              >
                Bạn cần hỗ trợ?
              </p>
              <p className="text-caption">
                Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp bạn giải quyết
                mọi vấn đề.
              </p>
            </div>
          </div>

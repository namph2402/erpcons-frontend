...
export default function PersonalHome() {
  ...
  const filteredTasks = useMemo(() => {
    if (taskTab === 'doing') return tasks.filter((t) => !t.done && t.state !== 'overdue')
    if (taskTab === 'overdue') return tasks.filter((t) => t.state === 'overdue')
    ...
    >
      <div className="page">
        <div className="greeting">
          <div>
            <h1 className="greeting__title">Chào buổi sáng, {personalUser.name}! 👋</h1>
        ...
        <div className="grid-main-aside">
          <div className="col-stack">
            <ProfileCard
              ...
              stats={[
                { id: 'st1', label: 'Ngày làm việc', value: '18', total: '22', caption: 'Tháng 05/2024', icon: 'event_available', tone: 'info' },
                { id: 'st2', label: 'Giờ làm việc', value: '142.5', total: '176h', caption: 'Đã duyệt', icon: 'schedule', tone: 'success' },
                { id: 'st3', label: 'Nghỉ phép năm', value: '8.5', total: '20 ngày', caption: 'Đã dùng', icon: 'beach_access', tone: 'warning' },
                { id: 'st4', label: 'Công việc quá hạn', value: '2', caption: 'Cần xử lý', icon: 'error', tone: 'danger' },
              ]}
            />
            ...
            <div className="grid-main-aside">
              <Card title="Công việc của tôi" link={{ label: 'Xem tất cả' }}>
                ...
                />
                <TaskList tasks={filteredTasks} onToggle={toggleTask} variant="detailed" />
              </Card>
            ...
            <div className="grid-3">
              <Card title="Ngày phép" link={{ label: 'Xem chi tiết' }}>
                <DonutChart
                  ...
                  showPercent={false}
                />
                <p className="text-caption" style={{ marginTop: 'var(--sp-4)', textAlign: 'center' }}>
                  Tổng <strong>20 ngày phép</strong> / năm
                </p>
              </Card>

              <Card title="Bảng lương mới nhất" link={{ label: 'Xem chi tiết' }}>
                  ...
                  {GOALS.map((g) => (
                    <div className="goal" key={g.id}>
                      ...
                      <div className="goal__body">
                        ...
                        <ProgressBar value={g.progress} tone={g.tone} size="sm" className="goal__bar" />
          ...
          <div className="col-stack">
            <Card title="Lịch tháng 05/2024" link={{ label: 'Xem lịch' }}>
              <MiniCalendar month={5} year={2024} selected={22} marked={[11, 15, 22, 25, 26, 29, 30, 31]} />
            </Card>

            <Card title="Thông báo" link={{ label: 'Xem tất cả', onClick: () => setDrawerOpen(true) }}>
            ...
            <Card title="Danh bạ" link={{ label: 'Xem tất cả' }}>
              ...
              <div className="contact-grid">
                ...
                <div className="contact-grid__item">
                  <span className="avatar-group__more" style={{ width: 40, height: 40, marginLeft: 0 }}>
                    +12
                  </span>
                </div>
              </div>

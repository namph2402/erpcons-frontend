...
export const personalMeetings: MeetingItem[] = [
  {
    ...
    tone: 'info',
    attendees: [{ name: 'Trần Minh Đức' }, { name: 'Lê Hải Đăng' }, { name: 'Phạm Quang Huy' }, { name: 'Vũ Thị Hương' }],
  },
  {
    id: 'pm2',
    from: '10:00',
    ...
    place: 'Phòng họp A',
    tone: 'info',
    attendees: [{ name: 'Nguyễn Hoàng Nam' }, { name: 'Lê Hải Đăng' }, { name: 'Trần Minh Đức' }],
  },
  {
    id: 'pm3',
    from: '11:30',
  ...
  },
  {
    ...
    place: 'Phòng họp Online',
    tone: 'info',
    attendees: [{ name: 'Trần Minh Đức' }, { name: 'Nguyễn Hoàng Nam' }, { name: 'Lê Hải Đăng' }, { name: 'Vũ Thị Hương' }, { name: 'Phạm Quang Huy' }],
  },
]
...
export const notifications: NotificationItem[] = [
  {
    ...
    title: 'Phê duyệt hồ sơ thanh toán đợt 3',
    context: 'The Nexus Tower',
    description: 'Trần Minh Đức đã gửi hồ sơ thanh toán đợt 3 chờ bạn phê duyệt.',
    time: '08:45',
    icon: 'description',
    tone: 'info',
    unread: true,
...
export const ganttTasks: GanttTask[] = [
  { id: 'g1', name: '1. Công tác chuẩn bị', level: 0, progress: 100, start: 0, span: 6, tone: 'done' },
  { id: 'g1-1', name: '1.1. Giải phóng mặt bằng', level: 1, progress: 100, start: 0, span: 4, tone: 'done' },
  { id: 'g1-2', name: '1.2. Thi công hàng rào, lán trại', level: 1, progress: 100, start: 1, span: 4, tone: 'done' },
  { id: 'g1-3', name: '1.3. Định vị, cọc mốc', level: 1, progress: 100, start: 4, span: 3, tone: 'done' },
  { id: 'g2', name: '2. Thi công phần ngầm', level: 0, progress: 85, start: 3, span: 8, tone: 'doing' },
  { id: 'g2-1', name: '2.1. Đào đất, vận chuyển', level: 1, progress: 100, start: 3, span: 4, tone: 'doing' },
  { id: 'g2-2', name: '2.2. Thi công tường vây', level: 1, progress: 90, start: 5, span: 5, tone: 'doing' },
  { id: 'g2-3', name: '2.3. Thi công cọc khoan nhồi', level: 1, progress: 80, start: 7, span: 5, tone: 'doing' },
  { id: 'g2-4', name: '2.4. Thi công tầng hầm', level: 1, progress: 70, start: 10, span: 5, tone: 'doing' },
  { id: 'g3', name: '3. Thi công phần thân', level: 0, progress: 48, start: 12, span: 8, tone: 'doing', milestone: true },
  { id: 'g3-1', name: '3.1. Thi công kết cấu đến tầng 20', level: 1, progress: 48, start: 12, span: 5, tone: 'doing' },
  { id: 'g3-2', name: '3.2. Thi công kết cấu còn lại', level: 1, progress: 0, start: 15, span: 6, tone: 'plan' },
]

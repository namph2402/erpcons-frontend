...
export const enterpriseNav: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'search', label: 'Tìm kiếm doanh nghiệp', icon: 'search', href: '#/search' },
      { id: 'workspace', label: 'Không gian làm việc', icon: 'grid_view', href: '#/workspace' },
      { id: 'tasks', label: 'Công việc & Quy trình', icon: 'checklist', href: '#/tasks' },
      { id: 'projects', label: 'Dự án', icon: 'domain', href: '#/du-an' },
      { id: 'construction', label: 'Xây dựng', icon: 'engineering', href: '#/construction' },
      { id: 'quality', label: 'Chất lượng / HSE', icon: 'verified_user', href: '#/quality' },
      { id: 'finance', label: 'Tài chính', icon: 'payments', href: '#/finance' },
      { id: 'hr', label: 'Nhân sự', icon: 'groups', href: '#/hr' },
      { id: 'crm', label: 'CRM', icon: 'handshake', href: '#/crm' },
      { id: 'warehouse', label: 'Kho', icon: 'warehouse', href: '#/warehouse' },
      { id: 'assets', label: 'Tài sản & Thiết bị', icon: 'precision_manufacturing', href: '#/assets' },
      { id: 'documents', label: 'Tài liệu', icon: 'folder_open', href: '#/documents' },
      { id: 'reports', label: 'Báo cáo & Phân tích', icon: 'insights', href: '#/reports' },
